...
export default function TopAnnouncementBar() {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#0d1017] via-[#141923] to-[#0d1017] border-b border-white/[0.06] text-slate-300 text-[11px] sm:text-xs py-1.5 px-3 sm:px-6 md:px-8 relative overflow-hidden transition-all">
      ...
      <div className="w-full flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="hidden md:flex items-center gap-2 text-slate-400 font-mono text-[10px] tracking-wider shrink-0">
