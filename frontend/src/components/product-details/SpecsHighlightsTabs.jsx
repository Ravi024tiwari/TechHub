...
export default function SpecsHighlightsTabs({ product }) {
  ...
  return (
    <div className="space-y-6 pt-10 border-t border-slate-200 dark:border-white/10 text-left w-full">
      {/* =========================================================================
          TAB NAVIGATION HEADER: Responsive Scrollable Segmented Capsule Dock
          ========================================================================= */}
      <div className="w-full pt-1 pb-2">
        <div className="w-full overflow-x-auto scrollbar-none py-1 px-0.5 flex items-center justify-start sm:justify-center">
          <div className="inline-flex items-center p-1 sm:p-1.5 rounded-2xl sm:rounded-full bg-white dark:bg-[#0c0e14] border-2 border-slate-200 dark:border-white/10 shadow-sm gap-1 sm:gap-2 shrink-0 mx-auto sm:mx-0">
            <button
              type="button"
              onClick={() => setActiveTab("overview")}
              className={`flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-6 py-2 sm:py-2.5 rounded-xl sm:rounded-full text-xs sm:text-sm font-heading transition-all cursor-pointer whitespace-nowrap border-2 shrink-0 ${
                activeTab === "overview"
            ...
            >
              ...
              <span className={activeTab === "overview" ? "text-white font-extrabold" : "text-slate-700 dark:text-slate-300 font-semibold"}>
                ...
                <span className="hidden sm:inline">Overview & Highlights</span>
              </span>
            </button>
            ...
            >
              <Cpu className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-400 shrink-0" />
            ...
            >
              ...
              <span className={activeTab === "warranty" ? "text-white font-extrabold" : "text-slate-700 dark:text-slate-300 font-semibold"}>
                <span className="sm:hidden">Warranty & Box</span>
                <span className="hidden sm:inline">Warranty & In-The-Box</span>
              </span>
            </button>
          </div>
        </div>
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      {activeTab === "overview" && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-8 items-start w-full animate-in fade-in duration-200">
          {/* LEFT COLUMN: Architecture & Narrative Card */}
          <div className="lg:col-span-7 xl:col-span-8 space-y-4 sm:space-y-6">
            <div className="p-4 sm:p-6 lg:p-7 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#0c0e14] border-2 border-slate-200 dark:border-white/10 shadow-sm space-y-4">
              ...
              <p className="text-xs sm:text-base leading-relaxed text-slate-700 dark:text-slate-300 font-sans whitespace-pre-line">
                {product.description ||
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-white/5 space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-2.5">
                    {features.map((feature, idx) => (
                      <div
                        key={idx}
                        className="flex items-start gap-2.5 p-2.5 sm:p-3 rounded-xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/5"
                      >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
              <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white dark:bg-[#0c0e14] border-2 border-slate-200 dark:border-white/10 shadow-xs flex items-center gap-3">
          ...
          <div className="lg:col-span-5 xl:col-span-4 space-y-4 w-full">
            <div className="p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#0c0e14] border-2 border-slate-200 dark:border-white/10 shadow-sm space-y-4">
